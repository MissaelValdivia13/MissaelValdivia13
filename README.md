...
Software Engineer specialized in the **.NET ecosystem**. I have professional experience building scalable web applications and microservices, implementing cloud solutions, and event-driven architectures in agile environments.

- 🚀 **Recent Experience:** Developed scalable services at **EPAM Systems** using .NET, RabbitMQ, and Elasticsearch.
- 🛠️ **Expertise:** Deep understanding of **Clean Architecture**, **SOLID principles**, and **JWT Security**.
- ☁️ **Cloud & DevOps:** Proficient in **Azure** (App Services, Functions) and **Docker** containerization.
- 🎓 **Education:** Bachelor's Degree in Computer Engineering from ITCG.
